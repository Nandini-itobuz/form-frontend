...
export const applicationZodSchema = z.object({
  ...
  lastName: z.coerce
    ...
    .min(3, { message: "Min 4 letters required" }),
  age: z.coerce
    .number()
    .int()
  ...
  phone: z.coerce
    ...
    .regex(phoneExpression, "Invalid Phone Number"),
  position: z.coerce
    .string()
    .min(1, { message: "Please enter position field" }),
  institution: z.coerce
    .string()
    .min(1, { message: "Please enter your institution" }),
